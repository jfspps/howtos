---
title: Source file basics part 4
nav_order: 5
parent: LaTeX
---
...
The [source file](./examples/example_4.tex) and (required) [document class file](./examples/sample.cls) are included. A generated PDF can be found [here](./examples/example_4.pdf).